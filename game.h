...
#define STATUS_BORF 7
#define STATUS_DEXTER 8
...
int StartingFrame;
short Dexter; // Stages played as Dexter instead of Ace.
short TMP_Dexter; // Stages played as Dexter instead of Ace before reaching a checkpoint.
short CurrentAction;
short Deaths;
short CreditsUsed;
short Pause;
...
typedef struct{
int Frame;
MOVIE_FILE *Movie[6]; // 0: No action, 1: up, 2: down, 3: left, 4: right, 5: Fire.
int RumbleFrame;
short RumbleType;
}SCENE;
...
ASSETS_FILE Assets = {SECTOR_ASSETS_DAT, 192};
